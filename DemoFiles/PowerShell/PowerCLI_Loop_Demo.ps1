...
$vcpass = 'pureuser'
$vccluster = 'TestDrive'
$volname = 'PowerCLI-Demo-Datastore'
$volcount = '5'
$volcapacityTB = '5'
...
1..$volcount | ForEach-Object { Write-Output "Volume name to be created is '$("$volname" + "$_")'" }
1..$volcount | ForEach-Object { New-PfaVmfs -Flasharray $array -Cluster (Get-Cluster $vccluster -Server $vc) -VolName $("$volname" + "$_") -SizeInTB $volcapacityTB }
